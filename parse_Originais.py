...
def parse(wildcard):
    """
    Formata os arquivos em um Pandas dataframe
    """
    dataframes = []
    for arquivo in glob.glob(wildcard):
        this = pandas.read_csv(
            arquivo,
            encoding='latin1',
            sep=';',
        )
        dataframes.append(this)
